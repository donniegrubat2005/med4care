...
@section('title', app_name() . ' | ' . __('labels.frontend.auth.register_box_title')) @push('after-styles')
<style>
    #card-form {
            ...
            <div class="card-body p-4">
                ...
                <div class="input-group mb-4">
                    ...
                    <select class="form-control" id="userRole" name="userRole">
                            ...
                            <option value="{{config('access.roles.team_owner')}}">{{ ucwords(config('access.roles.team_owner')) }}</option>
                            <option value="{{config('access.roles.user')}}">{{ ucwords(config('access.roles.user')) }}</option>
                        </select>
                </div>
                ...
                <hr>
                <button type="submit" class="btn btn-block btn-primary"> Register </button> {{-- {{ form_submit('Register')->class('btn-block
                btn-primary') }} --}}
            </div>
            {{ html()->form()->close() }}
