            ...
            <div class="col-sm-2">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        {!! $file['files'] !!} {{-- <img src="{{ $file['fileUrl'] }}" alt="{{$file['fileName']}}" id="{{$file['dbFile']}}"
                            class="img-thumbnail d-block img-doc"> --}}
                    </div>
                ...
                <div class="modal-dialog" role="document" style="border-radius:0px; border:1px solid #20a8d8">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-0">
                            {!! $file['files'] !!} {{-- <img src="{{ $file['fileUrl'] }}" alt="{{$file['fileName']}}" class="img-thumbnail"
                                style="width:100%"> --}}
                        </div>
                    </div>
                </div>
